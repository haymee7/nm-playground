...
public enum ResponseCode {
  ...
  SQL_SYNTAX_EXCEPTION("10001", "서비스 일시적인 오류"),
  PROPERTY_REFERENCE_EXCEPTION("10002", "관리자에게 문의하세요"),


  LOAD_PID("10101", "pid를 1이상의 값을 입력하세요"),
  PAGING_REQ_PARAM_INVALID_SP("10102", "sp는 0보다 큰 값이어야 합니다."),
  PAGING_REQ_PARAM_INVALID_CNT("10103", "cnt는 0보다 큰 값이어야 합니다."),
  ...
  BLOG_PAGING_REQ_PARAM_INVALID_SORT("BLOG_008", "sort는 D 또는 A 여야함"),
  ...
  BOOK_PAGING_INVAILD_ORDER("BOOK_0009", "order는 desc 또는 asc 이어야 함"),

  MOVIE_RETRIEVEONE_NULL("MOVIE_10001", "데이터 없음"),
  MOVIE_PAGING_REQ_PARAM_INVALID_SORT("MOVIE_10002", "sort의 값은 pid, director, actor, release_at, price, title");
